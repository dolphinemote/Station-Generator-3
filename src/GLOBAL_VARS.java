...
public class GLOBAL_VARS
{
    ...
    public static int space_border_length = 1;
    ...
    //app colors
    public static Color main_background_color = Color.BLACK;
    public static Color second_background_color = Color.DARK_GRAY;
    public static Color highlight_color = Color.YELLOW;
    public static Color main_text_color = Color.GRAY;
